...
```bash
git clone https://github.com/yourusername/worldline.git
cd worldline
```
...
- **Code Quality**: Laravel Pint code style checks
- **Security**: Composer security audit

Workflows are automatically triggered on push and pull requests to `main` and `develop` branches.
